...
void pool_return_integer(SchemeInteger* p) { g_int_pool.push_back(p); }
void pool_return_real(SchemeReal* p)       { g_real_pool.push_back(p); }
void pool_return_char(SchemeChar* p)       { g_char_pool.push_back(p); }
...
bool is_cons(const Value& val)             { return std::holds_alternative<ConsCell*>(val.repr); }
bool is_nil(const Value& val)              { return std::holds_alternative<NilAtom>(val.repr); }
bool is_void(const Value& val)             { return std::holds_alternative<VoidTag>(val.repr); }
bool is_boolean(const Value& val)          { return std::holds_alternative<BoolAtom>(val.repr); }
bool is_integer(const Value& val)          { return std::holds_alternative<SchemeInteger*>(val.repr); }
bool is_real(const Value& val)             { return std::holds_alternative<SchemeReal*>(val.repr); }
bool is_rational(const Value& val)         { return std::holds_alternative<SchemeRational*>(val.repr); }
bool is_complex(const Value& val)          { return std::holds_alternative<SchemeComplex*>(val.repr); }
bool is_exact_complex(const Value& val)    { return std::holds_alternative<ExactComplex*>(val.repr); }
bool is_character(const Value& val)        { return std::holds_alternative<SchemeChar*>(val.repr); }
bool is_string(const Value& val)           { return std::holds_alternative<SchemeString*>(val.repr); }
bool is_symbol(const Value& val)           { return std::holds_alternative<SymbolAtom>(val.repr); }
bool is_closure(const Value& val)          { return std::holds_alternative<SchemeClosure*>(val.repr); }
bool is_primitive(const Value& val)        { return std::holds_alternative<Builtin*>(val.repr); }
bool is_case_closure(const Value& val)     { return std::holds_alternative<CaseClosure*>(val.repr); }
bool is_promise(const Value& val)          { return std::holds_alternative<Promise*>(val.repr); }
bool is_multi_values(const Value& val)     { return std::holds_alternative<MultiValues*>(val.repr); }
bool is_record_type(const Value& val)      { return std::holds_alternative<RecordType*>(val.repr); }
bool is_record(const Value& val)           { return std::holds_alternative<Record*>(val.repr); }
bool is_parameter(const Value& val)        { return std::holds_alternative<Parameter*>(val.repr); }
bool is_error_object(const Value& val)     { return std::holds_alternative<ErrorObject*>(val.repr); }
bool is_continuation(const Value& val)     { return std::holds_alternative<Continuation*>(val.repr); }
bool is_syntax_transformer(const Value& val) { return std::holds_alternative<SyntaxTransformer*>(val.repr); }
bool is_environment(const Value& val)      { return std::holds_alternative<EnvBox*>(val.repr); }
bool is_record_accessor(const Value& val)  { return std::holds_alternative<RecordAccessor*>(val.repr); }
bool is_record_mutator(const Value& val)   { return std::holds_alternative<RecordMutator*>(val.repr); }
bool is_vector(const Value& val)           { return std::holds_alternative<SchemeVector*>(val.repr); }
bool is_bytevector(const Value& val)       { return std::holds_alternative<SchemeBytevector*>(val.repr); }
bool is_port(const Value& val)             { return std::holds_alternative<Port*>(val.repr); }
bool is_eof(const Value& val)              { return std::holds_alternative<EofTag>(val.repr); }
...
bool is_bignum(const Value& val) { return std::holds_alternative<SchemeBignum*>(val.repr); }
