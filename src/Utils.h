...
CEKSCHEME_API std::vector<std::string> retrieveFileList(const std::string& dirname);
...
CEKSCHEME_API void columnize(const std::vector<std::string>& lst,
...
struct CEKSCHEME_API ParenState {
    int               depth;
    bool              in_string;
...
CEKSCHEME_API ParenState paren_state(const std::string& text);
...
CEKSCHEME_API void writeln_multiFile(const std::string& output_string,
