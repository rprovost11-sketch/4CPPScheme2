...
static Value _form_include(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("include", a);
   }
static Value _form_include_ci(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("include-ci", a);
   }
static Value _form_cond_expand(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("cond-expand", a);
   }
static Value _form_define_library(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("define-library", a);
   }
static Value _form_import(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("import", a);
   }
