...
static Value _form_quote(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("quote", a);
   }
static Value _form_quasiquote(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("quasiquote", a);
   }
static Value _form_unquote(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("unquote", a);
   }
static Value _form_unquote_splicing(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("unquote-splicing", a);
   }
