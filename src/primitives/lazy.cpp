...
static Value _form_delay(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("delay", a);
   }
static Value _form_delay_force(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("delay-force", a);
   }
