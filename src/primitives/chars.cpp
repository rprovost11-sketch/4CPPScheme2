...
static Value _prim_char_eq(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare("char=?",  a, n, [](char32_t x, char32_t y){ return x == y; }); }
static Value _prim_char_lt(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare("char<?",  a, n, [](char32_t x, char32_t y){ return x <  y; }); }
static Value _prim_char_le(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare("char<=?", a, n, [](char32_t x, char32_t y){ return x <= y; }); }
static Value _prim_char_gt(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare("char>?",  a, n, [](char32_t x, char32_t y){ return x >  y; }); }
static Value _prim_char_ge(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare("char>=?", a, n, [](char32_t x, char32_t y){ return x >= y; }); }
...
static Value _prim_char_ci_eq(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare_ci("char-ci=?",  a, n, [](char32_t x, char32_t y){ return x == y; }); }
static Value _prim_char_ci_lt(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare_ci("char-ci<?",  a, n, [](char32_t x, char32_t y){ return x <  y; }); }
static Value _prim_char_ci_le(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare_ci("char-ci<=?", a, n, [](char32_t x, char32_t y){ return x <= y; }); }
static Value _prim_char_ci_gt(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare_ci("char-ci>?",  a, n, [](char32_t x, char32_t y){ return x >  y; }); }
static Value _prim_char_ci_ge(Context*, Environment*, std::vector<Value>& a, const Value* n)  { return _char_compare_ci("char-ci>=?", a, n, [](char32_t x, char32_t y){ return x >= y; }); }
...
static Value _prim_digit_value(Context*, Environment*, std::vector<Value>& args, const Value* app) {
    ...
    if (c >= U'0' && c <= U'9') return make_integer(static_cast<int64_t>(c - U'0'));
    // Common Unicode decimal digit blocks
    struct { char32_t base; } blocks[] = {
