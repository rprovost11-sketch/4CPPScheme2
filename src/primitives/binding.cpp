...
static Value _form_lambda(Context*, Environment*, std::vector<Value>&, const Value* a)             { return _stub("lambda", a); }
static Value _form_case_lambda(Context*, Environment*, std::vector<Value>&, const Value* a)        { return _stub("case-lambda", a); }
static Value _form_define(Context*, Environment*, std::vector<Value>&, const Value* a)             { return _stub("define", a); }
static Value _form_set(Context*, Environment*, std::vector<Value>&, const Value* a)                { return _stub("set!", a); }
static Value _form_let(Context*, Environment*, std::vector<Value>&, const Value* a)                { return _stub("let", a); }
static Value _form_let_star(Context*, Environment*, std::vector<Value>&, const Value* a)           { return _stub("let*", a); }
static Value _form_letrec(Context*, Environment*, std::vector<Value>&, const Value* a)             { return _stub("letrec", a); }
static Value _form_letrec_star(Context*, Environment*, std::vector<Value>&, const Value* a)        { return _stub("letrec*", a); }
static Value _form_let_values(Context*, Environment*, std::vector<Value>&, const Value* a)         { return _stub("let-values", a); }
static Value _form_let_star_values(Context*, Environment*, std::vector<Value>&, const Value* a)    { return _stub("let*-values", a); }
static Value _form_define_values(Context*, Environment*, std::vector<Value>&, const Value* a)      { return _stub("define-values", a); }
static Value _form_define_record_type(Context*, Environment*, std::vector<Value>&, const Value* a) { return _stub("define-record-type", a); }
