...
static Value _form_if(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("if", a);
   }
static Value _form_when(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("when", a);
   }
static Value _form_unless(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("unless", a);
   }
static Value _form_cond(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("cond", a);
   }
static Value _form_case(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("case", a);
   }
static Value _form_do(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("do", a);
   }
static Value _form_begin(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("begin", a);
   }
static Value _form_guard(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("guard", a);
   }
static Value _form_parameterize(Context*, Environment*, std::vector<Value>&, const Value* a)
   {
   return _stub("parameterize", a);
   }
