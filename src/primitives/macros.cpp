...
static Value _form_define_syntax(Context*, Environment*, std::vector<Value>&, const Value* a) { return _stub("define-syntax", a); }
static Value _form_let_syntax(Context*, Environment*, std::vector<Value>&, const Value* a)    { return _stub("let-syntax", a); }
static Value _form_letrec_syntax(Context*, Environment*, std::vector<Value>&, const Value* a) { return _stub("letrec-syntax", a); }
static Value _form_syntax_rules(Context*, Environment*, std::vector<Value>&, const Value* a)  { return _stub("syntax-rules", a); }
